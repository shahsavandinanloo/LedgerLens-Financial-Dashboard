...
def clean_data(file):
    ...
    def normalize_date(val):
        """استانداردسازی تاریخ شمسی به فرمت یکدستِ YYYY/MM/DD با صفرِ ابتدایی.
        این کار باعث می‌شود مرتب‌سازی و فیلترِ رشته‌ای درست کار کنند."""
...
# ---------------------------------------------------------
# تنظیمات سراسری قالب نمودارهای Plotly برای ظاهر حرفه‌ای‌تر
# ---------------------------------------------------------
custom_template = "plotly_white"

# ---------------------------------------------------------
# تابع ساخت محتوای تب‌ها (با چیدمان جدید و نمودارهای بزرگتر)
# ---------------------------------------------------------
